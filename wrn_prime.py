...
class WideResNet(nn.Module):
    def __init__(self, depth, num_classes=10, widen_factor=1, dropRate=0.0):
        ...
        # self.attn0 = Self_Attn(16*widen_factor)
        # self.attn1 = Self_Attn(32*widen_factor)
        # self.attn2 = Self_Attn(64*widen_factor)
    ...
    def forward(self, x):
        ...
        out = self.block2(out)
        out = self.block3(out)
        # out = self.attn0(self.block1(out))
        # out = self.attn1(self.block2(out))
        # out = self.attn2(self.block3(out))
